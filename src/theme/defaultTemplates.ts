...
const saintSeiyaLight: ThemeTokens = {
  ...
  danger: '#b4232f',
  success: '#22a06b',
  shadowPanel: '5px 5px 0 rgba(37,26,9,0.88), 0 18px 46px rgba(58,43,12,0.16)',
  shadowButton: '3px 3px 0 rgba(37,26,9,0.9)',
  shadowStrong: '7px 7px 0 rgba(37,26,9,0.9), 0 24px 72px rgba(58,43,12,0.22)',
  radiusPanel: '10px',
  radiusButton: '9999px',
  radiusNode: '12px',
  gridDot: '#9aaab6',
...
export const BUILT_IN_THEME_TEMPLATES: ThemeTemplate[] = [
  ...
  },
  {
    ...
    music: {
      ...
      volume: 0.16,
      bpm: 148,
      copyrightNote: '原创圣域小宇宙合成循环；冥界篇使用隐藏合成 preset。可在主题模板中替换为已授权音乐。',
    },
